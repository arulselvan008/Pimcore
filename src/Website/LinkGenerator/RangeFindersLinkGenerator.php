...
class RangeFindersLinkGenerator implements LinkGeneratorInterface
{
    ...
    {
        if (!($object instanceof RangeFinders)) {
            throw new \InvalidArgumentException('Given object is no RangeFinders');
        }
