...
class SparePartsLinkGenerator implements LinkGeneratorInterface
{
    ...
    public function generate(Concrete $object, array $params = []): string
    {
        if (!($object instanceof SpareParts)) {
            throw new \InvalidArgumentException('Given object is no SpareParts');
        }
