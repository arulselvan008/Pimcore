 ...
 * - TreeSize [input]
 * - Dimensions [input]
 * - EntranceWidth [inputQuantityValue]
 * - EntranceHeight [inputQuantityValue]
 * - Cover [input]
 * - TotalRoofKit [input]
 * - TotalHeight [inputQuantityValue]
 * - HeightPerSection [inputQuantityValue]
 * - Section [input]
 * - TotalWeight [inputQuantityValue]
 * - WeightPerSection [inputQuantityValue]
 * - MinimumTreeSize [inputQuantityValue]
 * - StepWidth [inputQuantityValue]
 * - WeightLimit [input]
...
return Pimcore\Model\DataObject\ClassDefinition::__set_state(array(
  ...
  Pimcore\Model\DataObject\ClassDefinition\Layout\Panel::__set_state(array(
   ...
   'linkGeneratorReference' => '@App\\Website\\LinkGenerator\\TreeStandLinkGenerator',
