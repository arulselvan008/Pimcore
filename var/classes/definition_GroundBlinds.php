 ...
 * - Windows [input]
 * - Construction [input]
 * - ShootingWidth [inputQuantityValue]
 * - StandingHeight [inputQuantityValue]
 * - HeightToBottomOfWindows [inputQuantityValue]
 * - CarryingBag [input]
 * - Stakes [input]
 * - Door [input]
 * - TotalWeight [inputQuantityValue]
 * - WindowsSecuring [input]
 * - BrushStrips [input]
 * - OtherFeatures [input]
 * - Size [input]
 * - OzoneGearPockets [input]
 * - Footprint [input]
 * - PriceType [select]
 * - Price [input]
 * - Availability [select]
...
return Pimcore\Model\DataObject\ClassDefinition::__set_state(array(
  ...
  Pimcore\Model\DataObject\ClassDefinition\Layout\Panel::__set_state(array(
   ...
   'linkGeneratorReference' => '@App\\Website\\LinkGenerator\\GroundBlindsLinkGenerator',
