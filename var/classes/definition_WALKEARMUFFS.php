 ...
 * - FeatureDescription [wysiwyg]
 * - Microphones [input]
 * - NoiseReductionRating [input]
 * - Battery [input]
 * - Speaker [input]
 * - Noise [input]
 * - VolumeControls [input]
 * - Housing [input]
 * - SoundActivatedCompression [input]
 * - NRR [input]
 * - Headband [input]
 * - BatteryDoor [input]
 */
            ...
            array (
              ...
              Pimcore\Model\DataObject\ClassDefinition\Data\Input::__set_state(array(
                ...
                array (
                 ...
                 'unique' => false,
                 'showCharCount' => false,
                 'name' => 'SoundActivatedCompression',
                 'title' => 'Sound Activated Compression',
                 'tooltip' => '',
                 'mandatory' => false,
                 'noteditable' => false,
                 'index' => false,
